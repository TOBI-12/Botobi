...
let { key } = await ananoffc.sendMessage(from, {text: 'ʟᴏᴀᴅɪɴɢ...'})//Pengalih isu

for (let i = 0; i < ananoffcofc; i++) {
/*await delay(10)*/
await ananoffc.sendMessage(from, {text: ananoffcofc[i], edit: key });//PESAN LEPAS
}
}
...
//GAME
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakgambar[m.sender.split('@')[0]]
        ...
        if (tebakasahotak.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakasahotak[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebaksiapakahaku.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Siapakah Aku 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaksiapakahaku[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebaksusunkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaksusunkata[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        ...
        if (tebakbendera2.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakbendera2[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebakkabupaten.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkabupaten[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebakkimia.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkimia[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebaktekateki.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaktekateki[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaklagu[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkata[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkalimat[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaklirik[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await ananoffc.sendText(m.chat, `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaktebakan[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
...
const text12 = `*Halo, @${sender.split("@")[0]}*
Perkenalkan Saya adalah AlwaysDann Assisten yang di ciptakan Oleh AlwaysDann , saya diciptakan untuk membantu Anda.
┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉
> YT: AlwaysDan
┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉
*〔 CREATE - BOT 〕*
...
_➵ .public_
_➵ .self_`
saluran gw: https://whatsapp.com/channel/0029VanrN2I5K3zQeHLYG818
...
break
          case 'qris': {
if (!isOwner) return reply('khusus AlwaysDann')             
ananoffc.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/s5sh8s.jpg' }, caption: ` _*JANGAN LUPA SS BUKTI SESUAI DENGAN NOMINAL YA*_` }, { quoted:m})        
} 
break
        case 'dana': {
if (!isOwner) return reply('khusus AlwaysAnan')
reply(`*DANA : 087811259488*
_*Sertakan Bukti Transfer, Tidak Ada Bukti Transfer Tidak Akan di Proses!*_`)       
}
break
        case 'gopay': {
if (!isOwner) return reply('khusus AlwaysDann')
reply(`*GOPAY : ga ada ajg* 
_*Sertakan Bukti Transfer, Tidak Ada Bukti Transfer Tidak Akan di Proses!*_`)       
}
break
        case 'ovo': {
if (!isOwner) return reply('khusus AlwaysDann')
reply(`*OVO : ga ada ajg*
_*Sertakan Bukti Transfer, Tidak Ada Bukti Transfer Tidak Akan di Proses!*_`)       
}
break
case 'bca': {
if (!isOwner) return reply('khusus AlwaysDann')
reply(`*BCA : ga ada ajg*
_*Sertakan Bukti Transfer, Tidak Ada Bukti Transfer Tidak Akan di Proses!*_`)       
}
break
case 'remini': {
...
break
        case 'public': {
if (!isOwner) return m.reply('Khusus AlwaysDann')
...
ananoffc.sendMessage(from, { text : `Hai Kak @${sender.split("@")[0]}, Nih Owner Ku Jangan Macam-macam Ya,🔥🔥`, contextInfo:{
forwardingScore: 9999999, 
isForwarded: true,
mentionedJid:[sender]
}}, { quoted: repf })        
...
break
case "addprem":{
if (!isOwner) return reply('Khusus AlwaysDamn')
...
// BAGIAN PANEL JANGAN LUPA SUBSCRIBE CHANNEL AlwaysAnan YAH GENGS
}    
...
ananoffc.sendMessage(u, { text: `*BERIKUT DETAIL AKUN PANEL ANDA*\n
╭─❏ *『 USER INFO 』*
┣❏ ➤ *📧EMAIL* : ${email}
┣❏ ➤ *👤USERNAME* : ${username}
┣❏ ➤ *🔐PASSWORD* : ${password.toString()}
...
let cpu = "10"
let disk = "0"
let email = username + "@anan.com"
akunlo = "https://files.catbox.moe/hg67a3.jpg" 
if (!u) return
let d = (await ananoffc.onWhatsApp(u.split`@`[0]))[0] || {}
